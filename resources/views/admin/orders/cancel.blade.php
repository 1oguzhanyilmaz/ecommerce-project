                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/admin/orders/cancel/' . $order->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" id="cancellation_note" name="cancellation_note"></textarea>
                        </div>

                        <button type="submit" class="btn btn-primary">Cancel the Order</button>
